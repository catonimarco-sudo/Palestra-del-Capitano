...
export const INITIAL_GYM_SCHEDULE: GymScheduleRow[] = [
  ...
  // 6. 18:45 (Track 1)
  {
    ...
    days: {
      ...
      mercoledi: {
        id: 'c_mer_1845_1',
        name: 'MASTERCLASS MISTER',
        category: 'funzionale',
        targetAudience: 'mister',
        instructor: 'Mister / Coach',
        room: 'Area Functional',
        duration: '55 min',
        notes: 'Sessione tecnica avanzata e aggiornamento metodologico riservata al Mister e Staff Tecnico.',
        enrolledMemberIds: [],
      },
      giovedi: {
        id: 'c_gio_1845_1',
  ...
  // 9. 19:30
  {
    ...
    days: {
      ...
      venerdi: {
        id: 'c_ven_1930',
        name: 'PREPARAZIONE MISTER',
        category: 'tonificazione',
        targetAudience: 'mister',
        instructor: 'Mister',
        room: 'Area Ring & Combat',
        duration: '45 min',
        notes: 'Allenamento e pianificazione riservata al Mister e Staff Tecnico.',
        enrolledMemberIds: [],
      },
    },
  },
